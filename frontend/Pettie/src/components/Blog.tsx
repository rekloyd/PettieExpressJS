/**
 * @file Blog.tsx
 * @description Componente de blog interactivo con artículos sobre el cuidado de mascotas, con paginación y contenido desplegable por tema.
 * @author Pau
...
const Blog: React.FC = () => {
  ...
  const blogs = [
    {
      title: "Alimentación Canina",
      summary: "Descubre los mejores consejos para mantener una dieta equilibrada para tu perro.",
      content: `
    ...
    {
      title: "Alimentación Felina",
      summary: "Conoce cómo alimentar correctamente a tu gato en cada etapa de su vida.",
      content: `
    ...
    {
      title: "Cuidados Generales de Mascotas",
      summary: "Vacunación, higiene y actividades para una vida plena.",
      content: `
    ...
    {
      title: "Ejercicio para Perros",
      summary: "Ideas de actividades para mantener activo a tu perro.",
      content: `
    ...
    },
    {
      ...
      summary: "Cómo mantener limpio y saludable el pelo de tu gato.",
      content: `
    ...
    },
    {
      ...
      summary: "Comandos esenciales que todo perro debe aprender.",
      content: `
    ...
    {
      title: "Cuidado de Mascotas Senior",
      summary: "Atención especial para perros y gatos mayores.",
      content: `
        ...
        {pageBlogs.map((blog, index) => {
          ...
          return (
            <div
              ...
              className="mb-4"
              onClick={() =>
                setSelected(selected === globalIndex ? null : globalIndex)
              }
              style={{
                cursor: "pointer",
