  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', maxWidth: '600px', margin: 'auto', padding: '1rem', fontSize: '20px' }}>
      <div style={{
        ...
        <img src={logo} alt="Logo de Pettie" style={{ marginBottom: 0, width: '243px', height: '161px' }} />
        <h2 style={{
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '1rem' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '14px' }}>
            ...
            He leído y acepto los <Link to="/terminos">términos y condiciones</Link><span style={{ color: 'red' }}>*</span>
          </label>
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '14px' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ marginTop: '1rem' }}>¿Ya tienes una cuenta? <Link to="/login">Inicia sesión</Link></p>
        </div>
