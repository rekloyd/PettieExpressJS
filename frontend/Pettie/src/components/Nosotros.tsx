    ...
    <div className="nosotros-container">
      ...
      <div className="nosotros-section">
        <div className="nosotros-text">
          ...
          <p>
            En Pettie, nuestra misión es mejorar la vida de las mascotas y sus
            dueños ofreciendo una plataforma segura, fácil de usar y centrada en
            el bienestar animal. Conectamos a cuidadores apasionados —los
            Pettiers— con propietarios que buscan confianza y cariño para sus
            perros.
          </p>
        </div>
      ...
      <div className="nosotros-section reverse">
        <div className="nosotros-text">
          <h2 style={{ fontFamily: "Madimi One, cursive" }}>
            Valores que nos definen
          </h2>
          <p>
            Nuestros pilares son la <strong>confianza</strong>, el{" "}
            <strong>compromiso</strong> y el{" "}
            <strong>amor por los animales</strong>. Cada Pettier es seleccionado
            cuidadosamente para garantizar el cuidado más responsable y
            afectuoso. Nos mueve la empatía, la comunidad y la transparencia.
          </p>
        </div>
      ...
      <div style={{ textAlign: "center" }}>
        <img src={banner} alt="Nuestra cultura" className="banner-img" />
      </div>
    </div>
  );
};
